                        ...
                        <div className="aspect-w-10 aspect-h-6 sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none overflow-hidden rounded shadow-xl lg:h-full">
                            <div className="relative bg-river-styx object-cover lg:h-full lg:w-full">
                                <div className="z-50 flex h-full w-full flex-col items-center justify-center space-y-5 bg-[#6C7EE1]/25 p-5">
                                    <h1 className=" py-3 px-4 text-3xl font-bold text-white">
                                        Claim Username
                                    </h1>
                                    <input
                                        type="email"
                                        placeholder="example@email.com"
                                        className="w-full rounded border-0 py-4 pl-4 text-sm text-white bg-river-styx font-semibold opacity-80 outline-none"
                                    />
                                    <div className="flex w-full justify-between rounded">
                                        <input
                                            type="text"
                                            placeholder="@username"
                                            className="w-full rounded border-0 py-4 pl-4 text-white text-sm font-semibold bg-river-styx opacity-80 outline-none"
                                        />
                                    ...
                                    {true ? (
                                        <button className="border-3 flex w-full items-center bg-white justify-between rounded border border-river-styx p-3  font-semibold">
                                            <span className="text-river-styx">
                                    ...
                                    {true ? (
                                        <button className="border-3 flex w-full text-river-styx bg-white items-center justify-between rounded border border-river-styx p-3  font-semibold">
                                            Connect Sol Wallet
                                            <img src="/sol.png" alt="" />
                                        </button>
                                    ) : (
