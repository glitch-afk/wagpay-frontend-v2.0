                ...
                <nav>
                    <div className=" flex flex-row justify-between">
                        <div className=" flex space-x-3 items-center">
                            <h1 className=" font-bold text-2xl leading-6 text-gray-100">
                                WagPay
                            </h1>
                        </div>

                        <div className=" hidden sm:flex xl:pl-4 lg:pl-3 justify-end flex-row sm:space-x-4 md:space-x-6 lg:space-x-3 xl:space-x-4">
                            <a className="rounded-md flex space-x-2 w-24 h-10 font-normal text-base leading-3 text-gray-100 cursor-pointer justify-center items-center">
                                <p>Dashboard</p>
                            </a>
                            <a className="rounded-md flex space-x-2 w-24 h-10 font-normal text-base leading-3 text-gray-100 cursor-pointer justify-center items-center">
                                <p>Docs</p>
                            ...
                            {/* Save button */}
                            <a className="rounded flex space-x-2 w-48 h-10 font-normal cursor-pointer text-base leading-3 text-white bg-bright-greek focus:outline-none focus:bg-indigo-800 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-indigo-600 duration-150 justify-center items-center">
                                <p>Getting Started</p>
                                <svg
